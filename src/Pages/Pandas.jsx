        ...
        <div className="bg-yellow-100 border border-yellow-300 rounded-lg p-6 flex flex-col md:flex-row items-center justify-between mb-8 mt-6 max-w-3xl mx-auto shadow">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            <button
              ...
              onClick={() => navigate('/pandas/project')}
            >
              Continue Project
            </button>
            <button
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="w-full relative px-4 lg:px-8 pb-12">
          ...
          <div className="flex flex-col lg:flex-row gap-6 mt-13 items-start">
            ...
            >
              <ConceptLearned skillName="pandas" completedProjects={completedProjects} />
            </motion.div>
                    ...
                    {project.publicUrl && (
                      <div className="flex gap-2 mt-2">
                        <button
                          ...
                          onClick={e => {
                            e.stopPropagation();
                            const url = project.publicUrl.replace('/public/pandas-project/', '/pandas-project/');
                        ...
                        <a
                          href={project.publicUrl.replace('/public/pandas-project/', '/pandas-project/')}
                          target="_blank"
