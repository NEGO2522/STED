    ...
    <div className="bg-white rounded-lg shadow-md p-6 border border-slate-200 max-200 h-76 mx-auto relative flex flex-col gap-2">
      ...
      <div className="flex justify-center mt-10">
        <div className="space-y-9 w-100">
          <button
            className={`w-full inline-flex items-center cursor-pointer justify-center gap-2 text-white font-semibold px-4 py-3 rounded-lg shadow-md transition-colors ${isGeneratingTask ? 'bg-indigo-700' : 'bg-indigo-600 hover:bg-indigo-700'}`}
